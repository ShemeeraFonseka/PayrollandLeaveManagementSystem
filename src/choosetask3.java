...
public class choosetask3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("View Employee Monthly Salary Report");
        ...
        jButton4.setText("Change & Reset Password");
...
ChangePassword3 c=new ChangePassword3();
c.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(choosetask3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new choosetask3().setVisible(true);
            }
        });
    }
